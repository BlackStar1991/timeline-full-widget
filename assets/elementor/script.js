(function () {
    ...
    function initTimelineAnimation(scopeEl) {
        ...
        const animateEnabled = wrapper.querySelector('.timeline-line-animation');
        ...
        function getTargetHeight() {
            ...
            if (rect.top < screenMiddle && rect.bottom > 0) {
                const progress = Math.min(1, (screenMiddle - rect.top) / rect.height);
    ...
    function initAllWidgets() {
        const widgets = document.querySelectorAll('[data-widget_type="za-timeline.default"]');
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (window.elementorFrontend && typeof elementorFrontend.hooks !== 'undefined') {
            elementorFrontend.hooks.addAction('frontend/element_ready/za-timeline.default', initTimelineAnimation);
        } else {
